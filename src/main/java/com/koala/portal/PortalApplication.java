...
public class PortalApplication {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        try {
            int sortVal = 1;
            FaqCategory faqCategoryGeneral = new FaqCategory(
                    0,
                    "General",
                    "General question about what K## is.",
                    true,
                    sortVal++
            );
            faqCategoryServices.save(faqCategoryGeneral);

            FaqCategory faqCategorySal = new FaqCategory(
                    0,
                    "SAL",
                    "General question about what SAL is.",
                    false,
                    sortVal++
            );
